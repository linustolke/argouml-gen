...
# Check out with
# svn co http://argouml-stats.tigris.org/svn/argouml-stats
...
if test "`(cd argouml-stats && svn info) | grep '^URL:'`" != "URL: http://argouml-stats.tigris.org/svn/argouml-stats"
then
...
( cd argouml-stats/trunk/www && ls */*/index.html ) |
